...
class lora_receive_file(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.lora_lora_receiver_0 = lora.lora_receiver(samp_rate, capture_freq, ([target_freq]), sf, 1000000, 0.01)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/carlos/git/LoRa_python_wrapper/data/lora-99-100.sigmf-data', False)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/carlos/git/gr-lora-0.6.2/misc/data/gr_record_out_channelizer', False)
        self.blocks_file_sink_0_0_0.set_unbuffered(False)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/carlos/git/gr-lora-0.6.2/misc/data/gr_record_out_resampler', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/carlos/git/gr-lora-0.6.2/misc/data/gr_record_in_channelizer', False)
        ...
        self.connect((self.lora_lora_receiver_0, 1), (self.blocks_file_sink_0_0, 0))
        self.connect((self.lora_lora_receiver_0, 0), (self.blocks_file_sink_0_0_0, 0))
        self.connect((self.lora_lora_receiver_0, 1), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.lora_lora_receiver_0, 0), (self.qtgui_time_sink_x_0_0, 0))
