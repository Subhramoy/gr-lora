...
class lora_receive_file(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/carlos/git/LoRa_python_wrapper/data/lora_input.sigmf-data', False)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex * 1, "/home/carlos/git/LoRa_python_wrapper/data/lora_output_chann", False)
        self.channelizer = lora.channelizer(10e6, 1e6, capture_freq, ([target_freq]))
        self.decoder = lora.decoder(1e6,7)
        ...
        self.connect((self.channelizer, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.channelizer, 0), (self.blocks_file_sink_0, 0))
